...
serve(async (req) => {
  ...
  try {
    ...
    const fullPrompt = `Create a professional Instagram carousel slide image. ${prompt}. ${paletteInfo} Style: ${visualDNA?.aesthetic || "Clean and modern"}. High quality, 1080x1350 portrait format, social media ready. No text overlays.`;
